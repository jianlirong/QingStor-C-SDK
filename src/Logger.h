 ...
 */
#ifndef _QINGSTOR_LIBQINGSTOR_LOGGER_H_
#define _QINGSTOR_LIBQINGSTOR_LOGGER_H_
...
#define LOG(s, fmt, ...) \
    QingStor::Internal::RootLogger.printf(s, fmt, ##__VA_ARGS__)

#endif /* _QINGSTOR_LIBQINGSTOR_LOGGER_H_ */
