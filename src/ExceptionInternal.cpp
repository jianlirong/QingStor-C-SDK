...
static void GetExceptionDetailInternal(const QingStor::QingStorException & e,
...
static void GetExceptionDetailInternal(const std::exception & e,
    ...
    try {
        QingStor::rethrow_if_nested(e);
    } catch (const QingStor::QingStorException & nested) {
